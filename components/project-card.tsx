...
const ProjectCard = ({
  ...
  return (
    <div className="flex flex-col items-center">
      <motion.div
        className="bg-white/10 sm:w-96 w-80 h-[28rem] sm:h-[31rem] rounded-xl sm:p-5 p-2 backdrop-blur-sm border border-transparent transition-all duration-300 ease-in-out shadow-lg"
        whileHover={{
          scale: 1.05,
        ...
        <div className="flex flex-col gap-3 justify-center">
          ...
          >
            <video
              ...
              muted
              playsInline
              className="pointer-events-none mx-auto h-40 w-full object-cover rounded-xl object-top"
            />
          </motion.div>
